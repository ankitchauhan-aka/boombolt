...
import { resetBagsize, saveBagsize, newBagsize, getBagsize } from '../store/bagsize/bagsizeSlice';
...
function BagsizeForm(props) {
	...
	const bagsize = useSelector(({ app }) => app.bagsize);
	...
	function saveSuccess() {
		alert.success('Saved!');
		props.history.push(`/admin/bagsizes`);
	}
			...
			<FusePageSimple
				...
				header={
					<Header
						...
						headText="ADD BAG SIZE"
						backLink="/admin/bagsizes"
						icon="local_offer"
					/>
				}
				content={
