					...
					<CardContent className="p-88 print:p-0">
						...
						<div className="flex justify-between">
							<div>
								...
								{props?.order?.user?.billingAddress?.streetaddress && (
									<Typography color="textSecondary">
										{
											(props?.order?.user?.billingAddress?.streetaddress[0],
											props?.order?.user?.billingAddress?.streetaddress[1])
										}
									</Typography>
								)}
							...
							<div className={clsx(classes.seller, 'flex items-center p-16')}>
								<img
									className="w-80"
									src="assets/images/logos/boombolt-black-logo-text.png"
									alt="logo"
								/>
								...
								<div className="px-8">
									<Typography color="inherit">BOOMBOLT Technology</Typography>

									<Typography color="inherit">295 Madison Avenue</Typography>
									<Typography color="inherit">12th Floor - New York</Typography>
									<Typography color="inherit">NY 10017, USA</Typography>
									<Typography color="inherit">844-965-8324</Typography>
								</div>
							</div>
						</div>
									...
									{props.order.orderItems.map(product => (
										<TableRow key={product.id}>
											...
											<TableCell align="right">
												{formatter.format(props.order.totalPrice)}
											</TableCell>
										</TableRow>
									))}
								</TableBody>
									...
									<TableRow>
										...
										<TableCell align="right">
											<Typography
												...
												color="textSecondary"
											>
												{formatter.format(props.order.taxPrice)}
											</Typography>
										</TableCell>
									</TableRow>
									{/* <TableRow>
