								...
								<div className="pb-48">
									...
									<div className="mb-24">
											...
											<table className="simple">
												...
												<tbody>
													<tr>
														...
														<td>
															<span className="truncate">{order.user.company}</span>
														</td>
													</tr>
												</tbody>
											</table>
										...
										>
											...
											<AccordionDetails className="flex flex-col md:flex-row">
												<Typography className="w-full md:max-w-256 mb-16 md:mb-0">
													{order?.user?.shippingAddress?.address}
												</Typography>
												<div className="w-full h-320">
													<GoogleMap
														...
														defaultZoom={15}
														defaultCenter={[
															order?.user?.shippingAddress?.lat,
															order?.user?.shippingAddress?.lng
														]}
													>
														<Marker
															text={order?.user?.shippingAddress?.address}
															lat={order?.user?.shippingAddress?.lat}
															lng={order?.user?.shippingAddress?.lng}
														/>
													</GoogleMap>
												</div>
											</AccordionDetails>
										...
										>
											...
											<AccordionDetails className="flex flex-col md:flex-row">
												<Typography className="w-full md:max-w-256 mb-16 md:mb-0">
													{order?.user?.billingAddress?.address}
												</Typography>
												<div className="w-full h-320">
													<GoogleMap
														bootstrapURLKeys={{
														...
														defaultZoom={15}
														defaultCenter={[
															order?.user?.billingAddress?.lat,
															order?.user?.billingAddress?.lng
														]}
													>
														<Marker
															text={order?.user?.billingAddress?.address}
															lat={order?.user?.billingAddress?.lat}
															lng={order?.user?.billingAddress?.lng}
														/>
													</GoogleMap>
												</div>
											</AccordionDetails>
